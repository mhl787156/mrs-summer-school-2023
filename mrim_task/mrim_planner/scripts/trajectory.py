...
class TrajectoryUtils():
    ...
    def resolveCollisions(self, method, problem, trajectories, safety_distance):
        ...
        ## |  [COLLISION AVOIDANCE METHOD #2]: Delay UAV with shorter trajectory at start until there is no collision occurring  |
            ...
            # [STUDENTS TODO] CHANGING - Mickey
            sorted_times = np.argsort(traj_times)
            delay_robot_idx, nondelay_robot_idx = sorted_times[0], sorted_times[1]
            ...
            while collision_flag:
                ...
                print(f"Collision Detected, delaying {delay_t} for drone {delay_robot_idx}")
                # if i < 10:
                delay_t += delay_step
                ...
                #     print(f"Collision Detected, surpa")
